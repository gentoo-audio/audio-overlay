...
SRC_URI="https://downloads-na.bitwig.com/stable/${PV}/${P}.deb"
LICENSE="Bitwig"
SLOT="0"
KEYWORDS="~amd64"
RESTRICT="mirror"
...
src_install() {
	...
	fperms 755 ${BITWIG_HOME}/lib/jre/lib/jexec \
		${BITWIG_HOME}/lib/jre/lib/jspawnhelper \
		${BITWIG_HOME}/lib/jre/lib/libawt_headless.so \
		${BITWIG_HOME}/lib/jre/lib/libawt.so \
		${BITWIG_HOME}/lib/jre/lib/libawt_xawt.so \
		${BITWIG_HOME}/lib/jre/lib/libdt_socket.so \
		${BITWIG_HOME}/lib/jre/lib/libfontmanager.so \
		${BITWIG_HOME}/lib/jre/lib/libj2gss.so \
		${BITWIG_HOME}/lib/jre/lib/libjavajpeg.so \
		${BITWIG_HOME}/lib/jre/lib/libjava.so \
		${BITWIG_HOME}/lib/jre/lib/libjawt.so \
		${BITWIG_HOME}/lib/jre/lib/libjdwp.so \
		${BITWIG_HOME}/lib/jre/lib/libjimage.so \
		${BITWIG_HOME}/lib/jre/lib/libjli.so \
		${BITWIG_HOME}/lib/jre/lib/libjsig.so \
		${BITWIG_HOME}/lib/jre/lib/libjsound.so \
		${BITWIG_HOME}/lib/jre/lib/liblcms.so \
		${BITWIG_HOME}/lib/jre/lib/libmanagement.so \
		${BITWIG_HOME}/lib/jre/lib/libmlib_image.so \
		${BITWIG_HOME}/lib/jre/lib/libnet.so \
		${BITWIG_HOME}/lib/jre/lib/libnio.so \
		${BITWIG_HOME}/lib/jre/lib/libprefs.so \
		${BITWIG_HOME}/lib/jre/lib/libsplashscreen.so \
		${BITWIG_HOME}/lib/jre/lib/libverify.so \
		${BITWIG_HOME}/lib/jre/lib/libzip.so \
